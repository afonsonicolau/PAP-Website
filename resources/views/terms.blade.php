        ...
        <section id="portfolio" class="portfolio section-bg">
            <div class="container">
                <div class="section-title" data-aos="fade-left">
                    <h2>Olfaire - Política/Termos e Condições</h2>
                    <p>Bem-vindo à <b>Olfaire Mendes&Nicolau</b> Estas políticas/termos e condições definem as regras e regulamentos para a utilização do website pertencente à empresa referida.</p> 

                    <p>Ao aceder a este site, presumimos que aceita estes termos e condições na totalidade. Não continue a utilizar o site da <b>Olfaire Mendes&Nicolau</b> se não aceitar todos os termos e serviços referidos nesta página.</p> 

                    A terminologia seguinte aplica-se as estes Termos e Condições, Política de Privacidade e Aviso de Isenção de Responsabilidade, assim como a todo e qualquer acordo: Cliente, Você e Seu referem-se a si, a pessoa que está a aceder a este website para aceitar os termos e condições da Empresa. A Empresa, Nós e Nosso, referem-se à nossa Empresa. Entidade, Entidades, ou Nós, referem-se tanto ao Cliente como a nós, ou só ao cliente ou a nós.

                    Todos os termos referem-se à oferta, aceitação e consideração do pagamento necessário para levar a cabo o processo da nossa assistência ao Cliente da forma mais apropriada, seja através de reuniões formais de duração fixa, ou qualquer outro meio, com o objetivo expresso de cumprir as necessidades do Cliente no que diz respeito ao fornecimento dos serviços/produtos da Empresa, de acordo com, e sujeito à lei vigente de (Endereço).

                    Qualquer uso da terminologia acima ou outras palavras no singular, plural, em maiúscula/minúscula e/ou ele/ela ou eles/elas são tomados como intermutáveis e, portanto, referem-se ao mesmo.

                    Cookies

                    Utilizamos cookies. Ao usar o site da (Nome da Loja) consente a utilização de cookies de acordo com a política de privacidade da (Nome da Loja). A maioria dos sites interativos de hoje em dia usam cookies que nos permitem recuperar os detalhes do utilizador para cada visita.
                    ...
                    <p><b>O Cliente não deve:</b></p> 

                    <ul>
                        <li>Republicar material de www.olfaire.pt;</li>
                        <li>Vender, alugar ou sub-licenciar material de www.olfaire.pt:</li>
                    ...
                    <p>No limite máximo permitido pela lei aplicável, excluímos todas as representações, garantias e condições relacionadas com o nosso website e com a utilização deste site (incluindo, sem limitação, qualquer garantia implícita na lei a respeito de qualidade satisfatória, adequação ao propósito e/ou utilização de cuidado e habilidade razoável).</p> 

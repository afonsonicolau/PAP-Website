...
@section('content')
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
					<div class="ps-hotspot"><a class="point first active" href="javascript:;"><i class="fa fa-plus"></i>
						...
						<p class="heading">JUMP TO HEADER</p>
						<p>Dynamic Fit Collar en la zona del tobillo que une la parte inferior de la pierna y el pie sin reducir la libertad de movimiento.</p>
						</div></a><img src="/assets/onlineshop/images/hot-deal.png" alt=""></div>
				</div>
			</div>
		</div>
		</div>
	...
	{{-- <div class="ps-section ps-section--top-sales ps-owl-root pt-80 pb-80">
		...
		<div class="ps-section__content">
			...
			<div class="ps-shoes--carousel">
				<div class="ps-shoe">
				<div class="ps-shoe__thumbnail">
					<div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="/assets/onlineshop/images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
				</div>
				<div class="ps-shoe__content">
					<div class="ps-shoe__variants">
					<div class="ps-shoe__variant normal"><img src="/assets/onlineshop/images/shoe/2.jpg" alt=""><img src="/assets/onlineshop/images/shoe/3.jpg" alt=""><img src="/assets/onlineshop/images/shoe/4.jpg" alt=""><img src="/assets/onlineshop/images/shoe/5.jpg" alt=""></div>
					<select class="ps-rating ps-shoe__rating">
						<option value="1">1</option>
						<option value="1">2</option>
						<option value="1">3</option>
			...
			<div class="ps-shoes--carousel">
				...
				<div class="ps-shoe__thumbnail">
					<div class="ps-badge"><span>New</span></div>
					<div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="/assets/onlineshop/images/shoe/2.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
				</div>
				<div class="ps-shoe__content">
					<div class="ps-shoe__variants">
					<div class="ps-shoe__variant normal"><img src="/assets/onlineshop/images/shoe/2.jpg" alt=""><img src="/assets/onlineshop/images/shoe/3.jpg" alt=""><img src="/assets/onlineshop/images/shoe/4.jpg" alt=""><img src="/assets/onlineshop/images/shoe/5.jpg" alt=""></div>
			...
			<div class="ps-shoes--carousel">
				<div class="ps-shoe">
				<div class="ps-shoe__thumbnail">
					<div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="/assets/onlineshop/images/shoe/3.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
				</div>
				<div class="ps-shoe__content">
					<div class="ps-shoe__variants">
					<div class="ps-shoe__variant normal"><img src="/assets/onlineshop/images/shoe/2.jpg" alt=""><img src="/assets/onlineshop/images/shoe/3.jpg" alt=""><img src="/assets/onlineshop/images/shoe/4.jpg" alt=""><img src="/assets/onlineshop/images/shoe/5.jpg" alt=""></div>
			...
			<div class="ps-shoes--carousel">
				<div class="ps-shoe">
				<div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="/assets/onlineshop/images/shoe/4.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
				</div>
				<div class="ps-shoe__content">
					<div class="ps-shoe__variants">
					<div class="ps-shoe__variant normal"><img src="/assets/onlineshop/images/shoe/2.jpg" alt=""><img src="/assets/onlineshop/images/shoe/3.jpg" alt=""><img src="/assets/onlineshop/images/shoe/4.jpg" alt=""><img src="/assets/onlineshop/images/shoe/5.jpg" alt=""></div>
			...
			<div class="ps-shoes--carousel">
				<div class="ps-shoe">
				<div class="ps-shoe__thumbnail">
					<div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="/assets/onlineshop/images/shoe/5.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
				</div>
				<div class="ps-shoe__content">
					<div class="ps-shoe__variants">
					<div class="ps-shoe__variant normal"><img src="/assets/onlineshop/images/shoe/2.jpg" alt=""><img src="/assets/onlineshop/images/shoe/3.jpg" alt=""><img src="/assets/onlineshop/images/shoe/4.jpg" alt=""><img src="/assets/onlineshop/images/shoe/5.jpg" alt=""></div>
			...
			<div class="ps-shoes--carousel">
				<div class="ps-shoe">
				<div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="/assets/onlineshop/images/shoe/6.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
				</div>
				<div class="ps-shoe__content">
					<div class="ps-shoe__variants">
					<div class="ps-shoe__variant normal"><img src="/assets/onlineshop/images/shoe/2.jpg" alt=""><img src="/assets/onlineshop/images/shoe/3.jpg" alt=""><img src="/assets/onlineshop/images/shoe/4.jpg" alt=""><img src="/assets/onlineshop/images/shoe/5.jpg" alt=""></div>
	...
	{{-- <div class="ps-home-testimonial bg--parallax pb-80" data-background="/assets/onlineshop/images/background/parallax.jpg">
		...
		<div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
			...
			<div class="ps-testimonial__thumbnail"><img src="/assets/onlineshop/images/testimonial/1.jpg" alt=""><i class="fa fa-quote-left"></i></div>
			<header>
			...
			<div class="ps-testimonial">
			<div class="ps-testimonial__thumbnail"><img src="/assets/onlineshop/images/testimonial/2.jpg" alt=""><i class="fa fa-quote-left"></i></div>
			<header>
				<select class="ps-rating">
				<option value="1">1</option>
				<option value="1">2</option>
			...
			<div class="ps-testimonial">
			<div class="ps-testimonial__thumbnail"><img src="/assets/onlineshop/images/testimonial/3.jpg" alt=""><i class="fa fa-quote-left"></i></div>
			<header>
				<select class="ps-rating">
				<option value="1">1</option>
				<option value="1">2</option>
				...
				{{-- <div class="ps-section__content">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
							<div class="ps-post">
								<div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="/assets/onlineshop/images/blog/1.jpg" alt=""></div>
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
						<div class="ps-post">
							<div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="/assets/onlineshop/images/blog/2.jpg" alt=""></div>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
					<div class="ps-post">
						<div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="/assets/onlineshop/images/blog/3.jpg" alt=""></div>

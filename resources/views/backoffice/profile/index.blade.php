                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('backoffice.profile-changeinfo') }}">
                        ...
                        <div class="form-group hidden info" style="margin-top: 20px;">
                            ...
                            <input type="password" class="form-control" id="current_password" name="current_password" data-validate="yes" data-min="8" data-type="required" autocomplete="current-password"> 
                        </div>
